...
// keccak256(key . slot) => gets position of storage
  ...
  // 32 bytes total values stored in slot 0 => mapping now slot 2
  // 0x0f 01 4fabfbc310b6c8c6d276937b7d5adaa00bfd2497 000a 07
  
  
  uint256 public f = 200; // 32 bytes => slot 1 0xc8 => mapping now slot 3
  
  uint8 public g = 40; // 1byte => slot 2 0x28 => mapping now slot 4

  uint256 public h = 789; //32 bytes => slot3 0x0315 => mapping now slot 5
